...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  public AbstractHashMap(int cap, double maxLoad) { this(cap, 109345121, maxLoad); }  // default prime
  ...
  public void setMaxLoad(double maxLoad) {
    if (maxLoad <= 0.1 || maxLoad > 1.0)
      throw new IllegalArgumentException("maxLoad must be between 0.1 and 1.0 (exclusive/inclusive)");
  ...
  public V put(K key, V value) {
    ...
    if ((double) n / capacity > maxLoad)              // keep load factor <= 0.5
